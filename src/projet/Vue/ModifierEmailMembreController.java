 ...
 * @author ameliefiems
 */
public class ModifierEmailMembreController implements Initializable, ControlledEcran {
    ...
    @FXML
    public void modifierEmailMembre() {
        ...
        if (mem != null) {
            String message = Principal.pm.modifierGSMMembre(mem, nvxEmail.getText());
            String msg = "\n" + message;
            Alert alert = new Alert(Alert.AlertType.INFORMATION);
            alert.setTitle("Information modification du email du membre");
